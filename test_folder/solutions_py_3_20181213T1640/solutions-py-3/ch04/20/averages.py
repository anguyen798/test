...
#  It performs input validation on the query for additional students.
#
...
while moreGrades == "Y" :
   ...
   # While the provided input is not valid, give the user another chance.
   while moreGrades not in "YN" :
      moreGrades = input("Enter exam grades for another student (Y/N)? ")
      moreGrades = moreGrades.upper()
