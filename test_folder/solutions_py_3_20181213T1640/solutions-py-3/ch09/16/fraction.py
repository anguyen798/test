...
class Fraction :   
   ...
   #  @param rhsValue the right-hand side fraction
   #  @return a new Fraction object resulting from the multiplication
   #
   ...
   ## Divides a fraction with this fraction.
   #  @param rhsValue the right-hand side fraction
   #  @return a new Fraction object resulting from the division
   #
