##
#  Convert a time to its English name.
#
...
def getTimeName(hours, minutes) :
   # Handle the "special times" -- quarter, half, three quarters and hour.
   if minutes == 15 :
      return "quarter after " + hourName(hours)
   elif minutes == 30 :
      return "half past " + hourName(hours)
   elif minutes == 45 :
      return "quarter to " + hourName((hours + 1) % 12)
   elif minutes == 0 :
      return hourName(hours) + " o'clock"
   # Handle times in the first half of the hour.
   elif minutes < 30 :
      # Singular vs. plural minutes.
      if minutes == 1 : 
         min_word = " minute past "
      else :
         min_word = " minutes past "
      return intName(minutes) + min_word + hourName(hours)
   # Handle times in the second half of the hour.
   else :
      # Singular vs. plural minutes.
      if 60 - minutes == 1 :
         min_word = " minute before "
      else :
         min_word = " minutes before "
      return intName(60 - minutes) + min_word + hourName((hours + 1) % 12)
