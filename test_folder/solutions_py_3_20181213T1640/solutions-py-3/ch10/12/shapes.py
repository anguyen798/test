...
class Polygon(GeometricShape) :
   ...
   #  @param x the x portion of the vertex
   #  @param y the y portion of the vertex
   #
   ...
   def getX(self) :
      # Find the minimum x value in the polygon.
      xs = []
      for [a, b] in self._points :
         xs.append(a)

      return min(xs) + self._x

   ## Overrides the superclass method.
   def getY(self) :
      # Find the minimum y value in the polygon.
      ys = []
      for [a, b] in self._points :
         ys.append(b)

      return min(ys) + self._y

   ## Overrides the superclass method.
   def getWidth(self) :
      # Find the minimum and maximum x value in the polygon.
      xs = []
      for [a, b] in self._points :
         xs.append(a)
   ...
   ## Overrides the superclass method.
   def getHeight(self) :
      # Find the minimum and maximum y value in the polygon.
      ys = []
      for [a, b] in self._points :
         ys.append(b)

      # The difference is the height.
