...
class Onetime(Appointment) :
   ...
   #  @param outf a file handle that is open for writing
   #
   def save(self, outf) :
      outf.write("O|%d|%d|%d|%s\n" % (self._day, self._month, self._year, self._desc))
