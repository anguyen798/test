##
#  This program processes a digital image by creating a "sunset" image.
#
...
def main() :
   ...
   for row in range(height) :  # For each scan line
      ...
      # Skip the padding at the end of the row and flush the buffer.
...
def processPixel(imgFile) :
   ...
   # Process the pixel.
   newBlue = int(blue * 0.7)
   newGreen = int(green * 0.7)
   newRed = red
   
   # Write the pixel.
   imgFile.seek(-3, 1)   # Go back 3 bytes to the start of the pixel
