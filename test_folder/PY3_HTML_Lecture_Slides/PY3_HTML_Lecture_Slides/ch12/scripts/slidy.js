...
var w3c_slidy = {
    ...
    add_toolbar: function () {
        ...
        if (this.ns_pos || !this.ie6) {
            ...
            right.setAttribute("unorderedListClass", "float: right; text-align: right");
            ...
            left.setAttribute("unorderedListClass", "text-align: left");
...
if (w3c_slidy.ie6 || w3c_slidy.ie7) {
    ...
    "height='1' width='1' " +
    "unorderedListClass='position:absolute;left:-800px'></iframe>");
}
